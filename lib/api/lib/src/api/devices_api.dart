...
class DevicesApi {
  ...
  Future<Response<Device>> v1DevicesDeviceIdGet({ 
...
_responseData = rawData == null ? null : deserialize<Device, Device>(rawData, 'Device', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Device] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Device>> v1DevicesDeviceIdPatch({ 
    required String deviceId,
    ...
    try {
_bodyData=jsonEncode(updateDeviceRequest);
    } catch(error, stackTrace) {
      throw DioException(
...
_responseData = rawData == null ? null : deserialize<Device, Device>(rawData, 'Device', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [DeviceStatus] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DeviceStatus>> v1DevicesDeviceIdStatusGet({ 
    required String deviceId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/devices/{deviceId}/status'.replaceAll('{' r'deviceId' '}', deviceId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    DeviceStatus? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<DeviceStatus, DeviceStatus>(rawData, 'DeviceStatus', growable: true);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> v1DevicesDeviceIdUnregisterPost({ 
    required String deviceId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/devices/{deviceId}:unregister'.replaceAll('{' r'deviceId' '}', deviceId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DeviceList>> v1DevicesGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
...
_responseData = rawData == null ? null : deserialize<DeviceList, DeviceList>(rawData, 'DeviceList', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Device] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Device>> v1DevicesRegisterPost({ 
    ...
    final _path = r'/v1/devices:register';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
